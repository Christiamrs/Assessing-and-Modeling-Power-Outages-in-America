...
For this project I worked with 8 categories for this project as follows:

'demand.loss.mw', 'climate.region', 'areapct_urban', 'nerc.region', 'cause.category', 'outage.duration'
